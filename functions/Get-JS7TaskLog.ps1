...
(
    ...
    Process
    {
        ...
        $response = Invoke-JS7WebRequest -Path '/task/log/info' -Body $requestBody
        ...
        Add-Member -Membertype NoteProperty -Name 'controllerId' -value $JobSchedulerId -InputObject $objResult
