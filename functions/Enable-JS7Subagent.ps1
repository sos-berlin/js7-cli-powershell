function Enable-JS7Subagent
{
<#
.SYNOPSIS
Enables a previously disabled Subagent in the JS7 Controller
...
(
    ...
    End
    {
        ...
        if ( $PSCmdlet.ShouldProcess( 'agents', '/agents/inventory/cluster/subagents/enable' ) )
        {
            [string] $requestBody = $body | ConvertTo-Json -Depth 100
            $response = Invoke-JS7WebRequest -Path '/agents/inventory/cluster/subagents/enable' -Body $requestBody
            ...
            Write-Verbose ".. $($MyInvocation.MyCommand.Name): $($subagentIds.count) Subagents enabled"
        }
