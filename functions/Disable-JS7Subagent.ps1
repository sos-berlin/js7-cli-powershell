function Disable-JS7Subagent
{
<#
.SYNOPSIS
Disables a Subagent in the JS7 Controller
...
(
    ...
    End
    {
        ...
        if ( $PSCmdlet.ShouldProcess( 'agents', '/agents/inventory/cluster/subagents/disable' ) )
        {
            [string] $requestBody = $body | ConvertTo-Json -Depth 100
            $response = Invoke-JS7WebRequest -Path '/agents/inventory/cluster/subagents/disable' -Body $requestBody
            ...
            Write-Verbose ".. $($MyInvocation.MyCommand.Name): $($subagentIds.count) Subagents disabled"
        }
