...
.DESCRIPTION
This cmdlet renames a foldler in the JOC Cockpit inventory.

.PARAMETER Path
Specifies the directory and sub-directories of the folder.

.PARAMETER Name
Specifies the new directory and sub-directories of the folder.
...
Renames the specified folder including e.g. to move a sub-folder to a folder.
